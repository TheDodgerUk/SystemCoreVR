...
namespace Autohand {
    ...
    public class Hand : HandBase {
        ...
        public bool LockHandRotation = true;
        ...
        public static string grabbableLayerNameDefault = "VrInteraction";/// Layers.VrInteractionLayer;
        ...
        public static string rightHandLayerName = "ControllerRight";
        public static string leftHandLayerName = "ControllerLeft";
        ...
        protected override void Update() {
            ...
            base.Update();
            if (LockHandRotation == true && holdingObj == null)
            {

                body.angularVelocity = Vector3.zero;
                if (follow != null)
                {
                    body.rotation = follow.rotation;
                    lastFrameFollowRot = follow.rotation;
                }
