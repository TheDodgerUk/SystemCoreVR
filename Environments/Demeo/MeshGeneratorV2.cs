...
public class MeshGeneratorV2 : MonoBehaviour
{
    ...
    [EditorButton]
    private void ReGenerateWithSameSeed() => CreateNewMap();


    private void ReGenerateWithRandomSeed() => Start();
    void Start()
    {
        // Use this method if you havn't filled out the properties in the inspector
        // SetNullProperties(); 

        this.gameObject.ForceComponent<MeshRenderer>();
        mesh = new Mesh();
